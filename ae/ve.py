...
class ResNetEarlyLayersNoNorm(nn.Module):
    def __init__(
        self,
        in_channels: int,
        base_planes: int,
        ...
        super(ResNetEarlyLayersNoNorm, self).__init__()
        self.conv1 = nn.Sequential(
            nn.Conv2d(
                in_channels,
                base_planes,
...
def se_resneXt50_early(in_channels, base_planes, ngroups):
...
def se_resneXt50_early_nonorm(in_channels, base_planes, ngroups):
    model = ResNetEarlyLayersNoNorm(
        in_channels,
        base_planes,
        ngroups,
        SEResNeXtBottleneck,
...
def se_resneXt101_early(in_channels, base_planes, ngroups):
    model = ResNetEarlyLayers(
        in_channels,
        base_planes,
        ngroups,
