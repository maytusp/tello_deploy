...
from . import resnetbn_1st as resnet
# import resnetbn_early as resnet
...
class ResNetEncoder(nn.Module):
    def __init__(
        ...
        #     # nn.GroupNorm(1, 1024), # This is IN because num_groups=1
        #     # nn.ReLU(True),
        # )
...
if __name__ == "__main__":
    ...
    dec_block_config_str = "1x1,1u1,1t4,4x2,4u1,4t8,8x2,8u1,8t16,16x6,16u2,16t32,32x2,32u1,32t64,64x2,64u2,64t128,128x1"
    dec_channel_config_str = "256:64,128:64,64:64,32:128,16:128,8:256,4:512,1:128"
    ...
    # model_state_dict = visual_encoder.state_dict()
    # print("visual encoder=", visual_encoder)
    # model_path = "/mnt/iusers01/fatpou01/compsci01/n70579mp/habitat-lab/data/ckpt_pointnav_gibson_bn_finetune_clean/latest.pth"
    # checkpoint = torch.load(model_path)
    # new_checkpoint = {}
    # for k, v in checkpoint['state_dict'].items():
    #     k_new = k.replace("net.visual_encoder.", "")
    #     if k_new in model_state_dict:
    #         new_checkpoint[k_new] = v
    # visual_encoder.load_state_dict(new_checkpoint)
    # print("SUCCESFULLY LOADED")

    # torch.save(visual_encoder.state_dict(), '/mnt/iusers01/fatpou01/compsci01/n70579mp/split-diffuse-vae/pretrained_models/se_resneXt50_pointnav.pt')
